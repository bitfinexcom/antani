...
exports.signMessage = function (sk, message) {
  assert(typeof sk === 'string')
  assert(sk.length === exports.SECRETKEY_LEN)
...
exports.verifyMessage = function (pk, message, sig) {
  ...
  assert(sig.length === exports.SIGNATURE_LEN)
...
exports.signBucket = function (sk, bucket) {
  ...
  assert(sk.length === exports.SECRETKEY_LEN)
  assert(bucket)
  assert(typeof bucket.hash === 'string')
  assert(bucket.hash === exports.HASH_LEN)
...
exports.verifyBucket = function (bucket) {
  assert(bucket)
  assert(typeof bucket.signature === 'string')
  assert(bucket.signature === exports.SIGNATURE_LEN)
  assert(typeof bucket.key === 'string')
  assert(bucket.key === exports.PUBLICKEY_LEN)
