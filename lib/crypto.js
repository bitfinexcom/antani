...
exports.hashParent = function (a, b) {
  ...
  const buffers = [
    PARENT_PREFIX_BUF,
    encodeBalance(a.balance + b.balance),
...
exports.hashRoot = function (peaks) {
  ...
  for (var i = 0; i < peaks.length; i++) {
    ...
    buffers.push(encodeBalance(peak.balance))
    buffers.push(Buffer.from(peak.hash, 'base64'))
  }

  buffers[1] = encodeBalance(sum)
